...
public class FormularioResource {
	...
	@GetMapping
	@PreAuthorize("hasAuthority('ROLE_PESQUISAR_FORMULARIO') and #oauth2.hasScope('read')")
	...
	@PostMapping
	@PreAuthorize("hasAuthority('ROLE_CADASTRAR_FORMULARIO') and #oauth2.hasScope('write')")
